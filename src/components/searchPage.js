...
//pour revenir a l'ancienne liste puis on appel la fonction movies afin de refaire appel a l'api
  ...
  movies(){
    ...
    fetch(`https://api.themoviedb.org/3/search/movie?api_key=09421687e12e25c90450bb42455e1ecf&language=en-US&query=${search}&page=${this.state.index}&include_adult=false`)
