...
export default class Home extends React.Component {
  ...
  upComing(){
    fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=09421687e12e25c90450bb42455e1ecf&language=en-US&page=1')
    .then(response => response.json())
    .then(data => (this.setState({upcomingMovies: data.results})));
    fetch('https://api.themoviedb.org/3/movie/popular?api_key=09421687e12e25c90450bb42455e1ecf&language=en-US&page=1')
